...
class UserImagePickerDemo extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _UserImagePickerDemoState();
}

class _UserImagePickerDemoState extends State<UserImagePickerDemo> {
