...
class MySpeechApp extends StatefulWidget {
  const MySpeechApp({super.key});

  final String title = 'Flutter TTS';

  @override
  State createState() => _MySpeechAppState();
}

enum TtsState { playing, stopped, paused, continued }

class _MySpeechAppState extends State<MySpeechApp> {
  ...
  Future _speak() async {
    var systemVolume = await VolumeController().getVolume();
